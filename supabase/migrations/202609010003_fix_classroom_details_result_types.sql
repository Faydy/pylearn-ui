-- `classrooms.description` is varchar in the existing schema, while the RPC returns text.
-- Cast it explicitly so PostgreSQL accepts the declared return structure.
