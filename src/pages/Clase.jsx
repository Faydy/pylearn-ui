...
import ClassDeletionToast from '../components/classes/ClassDeletionToast';
...
export default function Clase() {
  ...
  return (
    ...
    </div></main><ClassDeletionToast />{showCreate && <CreateClassModal onClose={() => setShowCreate(false)} onCreate={handleCreate} />}{showJoin && <JoinClassModal onClose={() => setShowJoin(false)} onJoin={handleJoin} />}</div>
  );
}
