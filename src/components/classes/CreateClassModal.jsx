...
export default function CreateClassModal({ onClose, onCreate }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center overflow-y-auto bg-background/95 p-4 backdrop-blur-sm sm:items-center" role="dialog" aria-modal="true" aria-labelledby="create-class-title">
      <form onSubmit={handleSubmit} className="my-auto w-full max-w-lg rounded-2xl border border-border bg-ink p-4 shadow-2xl sm:p-6">
